 ...
 * ```
 */
export declare type JsonTheme = Tokens<Style | Style[]>;
/**
 ...
 * ```
 */
export interface HighlightJsTheme extends Tokens<(codePart: string) => string> {
    /**
 ...
 */
export declare const defaultHighlightJsTheme: HighlightJsTheme;
export declare function fromJson(json: JsonTheme): HighlightJsTheme;
export declare function toJson(theme: HighlightJsTheme): JsonTheme;
export declare function stringify(theme: HighlightJsTheme): string;
export declare function parse(json: string): HighlightJsTheme;
