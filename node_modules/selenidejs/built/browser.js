...
class Browser extends entity_1.Entity {
    ...
    with(customConfig) {
        return new Browser(Object.assign(Object.assign({}, this.configuration), customConfig));
    }
    get driver() {
    ...
    async executeScript(script, ...args) {
        const wrappedScript = `var args = arguments;${script instanceof Function
    ...
    async open(relativeOrAbsoluteUrl) {
        if (this.configuration.windowHeight && this.configuration.windowWidth) {
            await this.resizeWindow(parseInt(this.configuration.windowWidth, 10), parseInt(this.configuration.windowHeight, 10));
        }
